...
SparkesKoala <- list(
  ...
  Training_location = "C:/Users/uqgspar1/OneDrive - The University of Queensland/Documents/MATLAB/Koala_Accelerometry/Scripts/Gabbys Versions/Model Running 2024/Training Data/FinalTrainingData.csv",
  Unlabelled_location = "G:/Koala Data/Accelerometer Data/ Wild Data",
  ...
  behaviours_3 = list("Inactive" = c("Tree Sitting", "Sleeping/Resting", "Ground Sitting"),
                      ...
                      "NA" = c("Bellowing", "Shake", "Branch Walking"),
                      "Walking" = c("Walking", "Trot", "Gallop", "Bound/Half-Bound")),
  behaviours_4 = list("Inactive" = c("Tree Sitting", "Sleeping/Resting", "Ground Sitting"),
                      "Tree Movement" = c("Tree Movement", "Branch Walking","Swinging/Hanging", "Grooming", "Climbing Down", "Climbing Up", "Rapid Climbing"),
                      "Eating" = c("Foraging/Eating"),
                      "NA" = c("Shake", "Bellowing"),
                      "Walking" = c("Walking", "Trot", "Gallop", "Bound/Half-Bound")),
  behaviours_5 = list("Inactive" = c("Tree Sitting", "Sleeping/Resting", "Ground Sitting"),
                      "Tree Movement" = c("Tree Movement", "Branch Walking","Swinging/Hanging", "Climbing Down", "Climbing Up", "Rapid Climbing"),
                      "NA" = c("Shake", "Bellowing","Foraging/Eating","Grooming"),
                      "Walking" = c("Walking", "Trot", "Gallop", "Bound/Half-Bound")),
  target_behaviour = c("Walking")
)
