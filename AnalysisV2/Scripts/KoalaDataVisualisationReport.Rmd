...
sample_feature_cols <- removeBadFeatures(sample_feature_data, threshold = 0.5) 
...
Because in Gabby's research project she is only looking for some specific behaviours, I can simplify my analysis and improve performance by grouping stuff together into generalised classes. The classes I want to try to find are 'Walking', 'Still', 'Foraging/Eating' and 'Tree Movement' (with this last class being a generalised assortment).
