...
perform_optimal_model <- function(formatted_data, featuresList, optimal_window, optimal_overlap, 
                                  threshold, optimal_split, trainingPercentage, optimal_ntree, test_individuals){
  ...
  list_train_test <- split_condition(processed_data, modelArchitecture, threshold, optimal_split, trainingPercentage, test_individuals)
